...
const config = {
    host: "database-2.czxemm56p6xl.us-east-1.rds.amazonaws.com",
    port: 3306,
    user: "admin",
    password: "CARLOS1234",
    database: "ProductDB", // Este es el nombre de la base de datos que definiste al crear la instancia de RDS
};
